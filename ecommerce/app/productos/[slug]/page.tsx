...
const allProducts = [
  {
    ...
    longDescription:
      "Nuestro Pollo Broster Familiar es la elección perfecta para compartir en familia. Preparado con nuestra receta secreta de especias, el pollo queda dorado y crujiente por fuera, jugoso y tierno por dentro. Viene acompañado de papas fritas crocantes y una fresca ensalada de la casa.",
    price: 45.00,
    image: "/images/pollo-broster.jpg",
    slug: "pollo-broster-familiar",
    category: "Pollo Broster",
    emoji: "🍗",
    ingredients: ["Pollo entero", "Papas fritas", "Ensalada fresca", "Salsas especiales"],
    serves: "4 personas",
  },
  {
    id: "2",
    ...
    longDescription: "Porción perfecta para una persona. Todo el sabor de nuestro pollo broster en la medida justa para ti.",
    price: 18.00,
    image: "/images/pollo-personal.jpg",
    slug: "pollo-broster-personal",
    category: "Pollo Broster",
    emoji: "🍗",
    ingredients: ["Pollo (1/4)", "Papas fritas", "Ensalada", "Salsa"],
    serves: "1 persona",
  },
  {
    id: "3",
    ...
    longDescription: "Una combinación única de salchicha premium con nuestro pollo broster, acompañado de papas fritas y un toque especial de nuestras salsas de la casa.",
    price: 18.00,
    image: "/images/salchipollo.jpg",
    slug: "salchipollo-especial",
    category: "Pollo Broster",
    emoji: "🌭",
    ingredients: ["Salchicha premium", "Pollo broster", "Papas fritas", "Salsas especiales"],
    serves: "1 persona",
  },
  {
    id: "4",
    ...
    longDescription: "12 alitas de pollo marinadas con nuestros condimentos secretos, fritas hasta lograr el crujiente perfecto. Puedes elegir entre salsa BBQ dulce o salsa picante para acompañar.",
    price: 35.00,
    image: "/images/alitas.jpg",
    slug: "alitas-broster-12",
    category: "Alitas",
    emoji: "🍖",
    ingredients: ["12 alitas de pollo", "Aderezo especial", "Salsa BBQ o picante"],
    serves: "2-3 personas",
  },
  {
    id: "5",
    ...
    longDescription: "Porción personal de 6 alitas perfectamente crujientes. Elige tu salsa favorita: BBQ o picante.",
    price: 20.00,
    image: "/images/alitas-6.jpg",
    slug: "alitas-broster-6",
    category: "Alitas",
    emoji: "🍖",
    ingredients: ["6 alitas de pollo", "Aderezo especial", "Salsa a elegir"],
    serves: "1 persona",
  },
  {
    id: "6",
    ...
    longDescription: "El pack ideal para eventos y reuniones. Incluye una variedad de bocaditos salados: tequeños, empanadas, mini sandwiches y más. Todo preparado el mismo día para garantizar frescura.",
    price: 55.00,
    image: "/images/bocaditos.jpg",
    slug: "mix-bocaditos-50",
    category: "Bocaditos",
    emoji: "🥐",
    ingredients: ["Tequeños", "Mini empanadas", "Sandwiches", "Bocaditos variados"],
  ...
  },
  {
    ...
    longDescription: "24 tequeños artesanales rellenos de queso derretido, con una masa perfectamente dorada y crujiente. El aperitivo favorito para cualquier ocasión.",
    price: 30.00,
    image: "/images/tequenos.jpg",
    slug: "tequenos-24",
    category: "Bocaditos",
    emoji: "🥐",
    ingredients: ["Masa artesanal", "Queso especial", "Condimentos"],
    serves: "6-8 personas",
  },
  {
    id: "8",
    ...
    longDescription: "12 pastelitos dulces artesanales con diferentes rellenos: manjar blanco, frutas de temporada y crema. Perfectos para el postre o la merienda.",
    price: 28.00,
    image: "/images/pastelitos.jpg",
    slug: "pastelitos-dulces-12",
    category: "Pastelitos",
    emoji: "🧁",
    ingredients: ["Masa artesanal", "Manjar blanco", "Frutas", "Crema"],
    serves: "4-6 personas",
  },
  {
    id: "9",
    ...
    longDescription: "12 pastelitos salados con rellenos variados: pollo desmenuzado, carne sazonada y queso derretido. Ideales como aperitivo o merienda.",
    price: 25.00,
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50">
        ...
        <h1 className="font-display text-4xl text-orange-700 mb-4">Producto no encontrado</h1>
        <Link
          href="/productos"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-0">
          {/* Imagen */}
          <div className="relative h-72 md:h-full min-h-[320px] bg-gradient-to-br from-orange-100 to-amber-100 flex items-center justify-center">
            <span className="text-[9rem] opacity-40">{product.emoji}</span>
          ...
          <div className="p-8 md:p-10 flex flex-col justify-center">
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="text-sm text-gray-500">🍽️ Rinde para: <strong>{product.serves}</strong></span>
            </div>
