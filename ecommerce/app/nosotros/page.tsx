      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-orange-100 text-lg max-w-2xl mx-auto">
            Una familia, una pasión, un sabor que enamora
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              Bocaditos & Más nació de una pasión familiar por la buena comida y el deseo de compartir
              sabores auténticos con nuestra comunidad. Desde el primer día, nos hemos comprometido
              a usar solo ingredientes frescos y de la mejor calidad.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed">
              Nuestras recetas son el resultado de años de tradición familiar, combinadas con
              el toque especial que nos hace únicos en la ciudad.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-10">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center text-white">
            {[
              ...
              { number: "20+", label: "Productos en carta" },
