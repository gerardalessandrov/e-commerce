      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-24 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-white/70 text-lg sm:text-xl max-w-xl leading-relaxed mb-10 animate-fade-up delay-200">
            Pollo broster, alitas, bocaditos y pastelitos caseros. 
          ...
          <div className="flex items-center gap-6 mt-14 animate-fade-up delay-400">
            ...
            {/* ── BOTÓN DELIVERY WHATSAPP ── */}
            <a
              href={`https://wa.me/${WHATSAPP_PEDIDOS}?text=${mensajePredefinido}`}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 bg-green-500 hover:bg-green-400 active:scale-95 px-5 py-2.5 rounded-2xl shadow-lg shadow-green-900/30 transition-all duration-200 hover:shadow-green-500/40 hover:scale-105"
            >
              {/* WhatsApp icon */}
              <svg
              ...
              <div>
                <p className="text-white font-bold text-sm leading-none">Pedir por Delivery</p>
                <p className="text-green-100 text-[10px] mt-0.5 leading-none">Respuesta inmediata</p>
              </div>
              {/* Arrow */}
              <svg className="w-4 h-4 text-green-200 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
